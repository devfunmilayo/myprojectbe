...
router.post("/subscribe", async (req, res) => {
  ...
  try {
    await resend.emails.send({
      from: "Mercova Weekly <onboarding@resend.dev>",
      to: email,
                  ...
                  <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
                    ...
                    <tr>
                      <td style="padding:24px 40px 0;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#EFF6FF;border-radius:14px;padding:20px;margin-bottom:14px;">
                          <tr>
                            ...
                            <td style="vertical-align:top;">
                              ...
                              <p style="color:#6B7280;font-size:12px;line-height:1.6;margin:0 0 10px;">The #1 rated course on scaling your SaaS business from zero to $1M ARR.</p>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#FFF7ED;border-radius:14px;padding:20px;margin-bottom:14px;">
                          <tr>
                            ...
                            <td style="vertical-align:top;">
                              ...
                              <p style="color:#6B7280;font-size:12px;line-height:1.6;margin:0 0 10px;">150 pages of pure strategy. Build a one-person business that earns while you sleep.</p>
                              <table cellpadding="0" cellspacing="0"><tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#F5F3FF;border-radius:14px;padding:20px;">
                          <tr>
                            <td width="60" style="font-size:36px;vertical-align:top;padding-right:16px;">🎨</td>
                            <td style="vertical-align:top;">
                              ...
                              <p style="color:#6B7280;font-size:12px;line-height:1.6;margin:0 0 10px;">500+ production-ready React & Figma components. Ship beautiful products 10x faster.</p>
                              <table cellpadding="0" cellspacing="0"><tr>
                      ...
                      <td style="padding:24px 40px 0;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#F0FDF4;border-left:4px solid #16A34A;border-radius:0 12px 12px 0;padding:20px;">
                          <tr><td>
                            ...
                            <p style="color:#4B5563;font-size:13px;line-height:1.7;margin:0;">Package your expertise into a product once — earn from it forever. Start with what you already know.</p>
                          </td></tr>
                        </table>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding:32px 40px;text-align:center;">
                        <a href="https://myprojectfrontend-gamma.vercel.app/buyer" style="display:inline-block;background:#2563EB;color:#fff;font-size:15px;font-weight:800;padding:16px 40px;border-radius:14px;text-decoration:none;">Browse All Products →</a>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td colspan="2" style="padding-top:8px;">
                              <p style="font-size:11px;color:#D1D5DB;margin:0;">© 2026 Mercova. You're receiving this because you subscribed to our weekly digest.</p>
                            </td>
                          </tr>
                        </table>
                      </td>
